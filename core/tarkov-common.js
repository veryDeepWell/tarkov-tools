...
(function (global) {
  ...
  function ttRoot() {
    try {
      ...
      for (var i = scripts.length - 1; i >= 0; i--) {
        ...
        if (m) {
          // m[1] is .../core/ or .../ → normalize to site root
          var base = m[1];
  ...
  function init() {
    try { if (!document.querySelector("link[data-tt-sort]")) { var l=document.createElement("link"); l.rel="stylesheet"; l.href=ttUrl("core/tarkov-sort.css"); l.dataset.ttSort="1"; document.head.appendChild(l); } } catch(e) {}
  ...
  (function loadShared() {
    if (!document.querySelector("script[data-tt-names]")) {
      var n = document.createElement("script"); n.src = ttUrl("core/tarkov-names.js"); n.dataset.ttNames = "1"; n.async = false; document.head.appendChild(n);
    }
    if (!document.querySelector("script[data-tt-mini]")) {
      var s = document.createElement("script"); s.src = ttUrl("core/tarkov-mini.js"); s.dataset.ttMini = "1"; s.async = false; document.head.appendChild(s);
    }
    if (!document.querySelector("script[data-tt-ui]")) {
      var u = document.createElement("script"); u.src = ttUrl("core/tarkov-ui.js"); u.dataset.ttUi = "1"; u.async = false; document.head.appendChild(u);
    }
  })();
})(window);
