...
(function (global) {
  ...
  function addToMiniAndGoHub() {
    ...
    try {
      location.href = (location.pathname.indexOf('/tools/') >= 0 ? '../' : '') + 'tarkovtool-hub.html#mini=' + encodeURIComponent(file);
    } catch (e) {
      location.href = (location.pathname.indexOf('/tools/') >= 0 ? '../' : '') + 'tarkovtool-hub.html';
    }
  }
