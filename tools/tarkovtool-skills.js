  ...
  var SKILLS = [
    {
      ...
      soft:
        "После 1–2 порций перегрузочного бега множитель падает. Лучше чуть каждый рейд, чем час AFK с кирпичами. Чередуй со Endurance: скинул рюкзак → бег на лёгком."
    },
    {
      id: "endurance",
      name: "Endurance",
      ...
      cheese:
        "Лёгкий кит + длинные перебежки. ADS + hold breath между спринтами. Не качается от стояния. SJ6 / Meldonin дают временный буст, но если скилл ещё не Elite — стим выше 51 может блокировать XP в этом рейде.",
      soft: "Спринт до отвала в одном рейде быстро упирается в красную стрелку — чередуй с лутом / strength."
    },
    {
      id: "vitality",
      name: "Vitality",
    ...
    },
    {
      ...
      cheese:
        "Поинты = сколько восстановил недостающих шкалы, не факт «съел». В стейше UI врёт. Чиз: Mayo (+100 energy / −99 hyd) → сразу вода; или Ibuprofen (−17 hyd за юз, много юзов) по рейду → допей; Golden Star (−19 energy). Trimadol жрёт обе шкалы ~180 с — удобно для гринда. Ешь сначала (еда часто −hyd), потом пей. Junkie +2, A Life Lesson +1.",
      soft:
        "Очень быстро ловит кап. Не залпом всю бутылку — порция, пауза ~200 с или другой скилл. Elite 51: нет урона от истощения/обезвоживания. Нужен lvl 3 для Nutrition Unit 3."
    },
    {
      id: "stress",
    ...
    },
    {
      ...
      cheese:
        "В рейде набивай/опустошай маг между поинтами. В схроне тоже крутят, но надёжнее in-raid привычка.",
  ...
  function render() {
    ...
    SKILLS.forEach(function (sk) {
      ...
      div.innerHTML =
        ...
        '"></label><div></div><div><div class="meta">' +
        esc(sk.tip) +
